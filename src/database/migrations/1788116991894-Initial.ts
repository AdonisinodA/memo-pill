...
export class Initial1788116991894 implements MigrationInterface {
    name = 'Initial1788116991894'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "users" ("id" varchar PRIMARY KEY NOT NULL, "email" varchar NOT NULL, "password_hash" varchar NOT NULL, "name" varchar NOT NULL, "timezone" varchar NOT NULL DEFAULT ('America/Sao_Paulo'), "consent_at" integer NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"))`);
        await queryRunner.query(`CREATE TABLE "medications" ("id" varchar PRIMARY KEY NOT NULL, "user_id" varchar NOT NULL, "name" varchar NOT NULL, "dosage" varchar NOT NULL, "times" text NOT NULL, "starts_on" varchar NOT NULL, "ends_on" text, "deleted_at" integer, "created_at" datetime NOT NULL DEFAULT (datetime('now')))`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_medications" ("id" varchar PRIMARY KEY NOT NULL, "user_id" varchar NOT NULL, "name" varchar NOT NULL, "dosage" varchar NOT NULL, "times" text NOT NULL, "starts_on" varchar NOT NULL, "ends_on" text, "deleted_at" integer, "created_at" datetime NOT NULL DEFAULT (datetime('now')), CONSTRAINT "FK_3e8541ed0c975ed90ca265bb468" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_medications"("id", "user_id", "name", "dosage", "times", "starts_on", "ends_on", "deleted_at", "created_at") SELECT "id", "user_id", "name", "dosage", "times", "starts_on", "ends_on", "deleted_at", "created_at" FROM "medications"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "medications" ("id" varchar PRIMARY KEY NOT NULL, "user_id" varchar NOT NULL, "name" varchar NOT NULL, "dosage" varchar NOT NULL, "times" text NOT NULL, "starts_on" varchar NOT NULL, "ends_on" text, "deleted_at" integer, "created_at" datetime NOT NULL DEFAULT (datetime('now')))`);
        await queryRunner.query(`INSERT INTO "medications"("id", "user_id", "name", "dosage", "times", "starts_on", "ends_on", "deleted_at", "created_at") SELECT "id", "user_id", "name", "dosage", "times", "starts_on", "ends_on", "deleted_at", "created_at" FROM "temporary_medications"`);
